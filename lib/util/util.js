...
module.exports = {
    ...
    getStatisticsObject: function(stats, decimals) {
      return {
        ...
        p25: stats.percentile(25).toFixed(decimals),
        median: stats.median().toFixed(decimals),
        p70: stats.percentile(70).toFixed(decimals),
        p75: stats.percentile(75).toFixed(decimals),
        ...
        stddev: stats.stddev().toFixed(decimals)
      };
    },
    ...
    getURLFromPageData: function(pageData) {
      ...
      else if( pageData.headless && pageData.headless.runs && pageData.headless.runs.length > 0 )
      {
      	return pageData.headless.runs[0].url; // added in analyze/headless.js
      }
      return 'undefined';
    },
